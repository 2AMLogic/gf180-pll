...
#   sim/selftest.sh --record       also mint an evidence record under sim/harness-selftest/
...
args=(harness-selftest)
[ "${QUICK}" -eq 1 ] && args+=(--corners typical --temps 27 --supply-tol 0)
