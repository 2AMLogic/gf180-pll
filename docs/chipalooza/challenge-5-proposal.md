...
8. **The drawn blocks are 1.50× over the *draft* 0.15 mm² area target, that
   ...
   **0.0262 mm²**, 20 % of what the lever was sized at
   ...
   clique number is a floor for an assignment, not for a layout — where the
