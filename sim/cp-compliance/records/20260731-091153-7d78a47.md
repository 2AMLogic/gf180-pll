# Record 20260731-091153-7d78a47

- **Record ID**: 20260731-091153-7d78a47
...
- **Netlist provenance**: schematic (`design/cp.sch` and the cells below it)
  ...
  `sim/cp-compliance/netlist-snapshots/20260731-091153-7d78a47.spice`, SHA-256 `4a1ae45b766e895e927914702c0e2de6e8dd9c46de65d450378a16f46d4194c9`.
...
- **Result**:
  ...
  **UP/DN mismatch (systematic, nominal skew)**:
  ...
  Full tables: `sim/cp-compliance/corners/20260731-091153-7d78a47/cp_dc.csv` (per corner per
...
- **Links**:
  ...
  - Netlist snapshot: `sim/cp-compliance/netlist-snapshots/20260731-091153-7d78a47.spice`
  - Raw logs: `sim/cp-compliance/corners/20260731-091153-7d78a47/`
  - Extracted metrics: `sim/cp-compliance/corners/20260731-091153-7d78a47/cp_dc.csv`,
    `cp_switch.csv`, `cp_curves.csv`
- **Timestamp / author**: 2026-07-31T09:12:54Z, agent-builder (issue #9)
