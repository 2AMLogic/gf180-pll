...
2. **Closed-loop `period-jitter`'s random/noise-driven component has zero
   ...
   **no point of this campaign varies the output band away from band 6 /
   ...
   tracked at issue #505 and the 200 MHz band-top campaign at #503.
   **DR-020 records the disposition of the first**: the random component is
   ...
   row this document cannot report a number for. A defect in the
