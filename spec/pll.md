...
ceiling moves `h` by ≤ 0.024 % at every sampled phase, including the two
switching edges. What the bring-up *also* found is that the quantity the jitter
