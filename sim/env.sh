...
#   GF180_PDK_ROOT           back-compat with sim/lib/simenv.sh's own override
...
# (SC2296 is the zsh `${(%):-%x}` fallback below -- this file is sourced from
# both bash and zsh, so the fallback is intentional, not a typo.)
