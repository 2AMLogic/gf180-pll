# Record 20260731-184845-0a12e6c

- **Record ID**: 20260731-184845-0a12e6c
...
- **Netlist provenance**: schematic (`design/vco.sch` + `design/vco_bias.sch`
  ...
  `sim/vco-tuning-range/netlist-snapshots/20260731-184845-0a12e6c.spice`, SHA-256 `3d8bf1b307d7b230808c86b318262822fdf525c2503724609bdf51d1b1cc2d31`
...
- **Links**:
  ...
  - Netlist snapshot: `sim/vco-tuning-range/netlist-snapshots/20260731-184845-0a12e6c.spice`
  - Raw logs: `sim/vco-tuning-range/corners/20260731-184845-0a12e6c/` (one per PVT point)
  - Extracted metrics: `corners/20260731-184845-0a12e6c/supply_pushing.csv`,
    `corners/20260731-184845-0a12e6c/supply_jitter.csv`
  - Per-cycle period/TIE sequences (the waveform evidence behind the jitter
    ...
    `sim/README.md`): `corners/20260731-184845-0a12e6c/periods_*.csv`
- **Timestamp / author**: 2026-07-31T18:48:56Z, agent-builder (#8)
- **Supersedes**: 20260731-100401-07f4b7b -- netlist provenance only -- design/netlist.sh export-time path normalization (#28/PR #33); no electrical change, sch_path/sym_path comments only
