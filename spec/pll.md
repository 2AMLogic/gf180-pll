...
(DR-026, #509).** Until this paragraph the multiplication above rested on
...
the disposition DR-026 ratifies. Its limits are on the record's own face and in
DR-026 Decision 4: one N, five of 45 PVT points, two frequency points rather
...
different ask from the transfer figure measured above (DR-026).** Measuring that
