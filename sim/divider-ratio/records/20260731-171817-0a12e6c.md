# Record 20260731-171817-0a12e6c

- **Record ID**: 20260731-171817-0a12e6c
...
- **Netlist provenance**: schematic (`design/divider_chain.sch`, exported by
  ...
  `sim/divider-ratio/netlist-snapshots/20260731-171817-0a12e6c.spice` (exported
  subcircuit + testbench, concatenated), SHA-256 `0fb46ecefdb9b789ae69adc05984b1962836bd3063d05d637b06d882e849a8b2`
...
- **Methodology / criteria / limitations**:
  ...
  - Retiming budget: t_arr is DIVOUT's arrival referred to the VCO rising
    ...
    t_hold joined per PVT point from record 20260731-171815-0a12e6c.
...
- **Result**:
  ...
  **2. Retiming setup closure at 200 MHz, N=64 (k=6)**
  ...
  Per-point tables:
  `sim/divider-ratio/corners/20260731-171817-0a12e6c/chain_ratio.csv` and
  `sim/divider-ratio/corners/20260731-171817-0a12e6c/retiming_margin.csv`.
...
- **Links**:
  ...
  - Netlist snapshot: `sim/divider-ratio/netlist-snapshots/20260731-171817-0a12e6c.spice`
  - Raw logs: `sim/divider-ratio/corners/20260731-171817-0a12e6c/`
  - Extracted metrics: `sim/divider-ratio/corners/20260731-171817-0a12e6c/chain_ratio.csv`,
    `sim/divider-ratio/corners/20260731-171817-0a12e6c/retiming_margin.csv`
  - Setup/hold numbers joined from record: `sim/divider-ratio/records/20260731-171815-0a12e6c.md`
  - Single-cell evidence: `sim/divider-ratio/records/20260731-171816-0a12e6c.md`
- **Timestamp / author**: 2026-07-31T17:19:06Z, agent-builder (issue #11)
- **Supersedes**: 20260731-104619-2610998 -- netlist provenance only (design/netlist.sh export-time path normalization, #28/PR #33: sch_path/sym_path comments now repo-relative instead of the exporting checkout's absolute path); no electrical change, every measured value in this record reproduces the superseded record exactly (verified: Result table and per-corner CSVs `chain_ratio.csv`/`retiming_margin.csv` are byte-identical apart from the record-id-derived filename/timestamp header fields)
