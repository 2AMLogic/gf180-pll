...
S {}
E {}
T {nand2_3v3 - unit 2-input NAND (3.3 V thick oxide)} 100 -60 0 0 0.3 0.3 {layer=8}
T {* Unit 2-input static CMOS NAND.  The series NMOS stack is widened to 1u\n* (vs. 0.5u in inv_3v3) so the pull-down strength tracks the inverter's, keeping\n* the PFD's reset path delay symmetric between the UP and DN branches.} 1900 -300 0 0 0.25 0.25 {layer=8}
