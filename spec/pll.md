...
is narrower than it looks, and the band plan does not fix either (DR-024).**
...
2. **T1′ is met, and was already met before the trim.** At the trimmed cell it
   ...
   **1.796 ns** previously quoted for `ff`/125 °C/3.63 V is **not a steady
   ...
   reporting correctly, not failing. **DR-024 later narrows which of the two
