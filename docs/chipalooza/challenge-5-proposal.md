...
8. **The drawn blocks are 1.82× over the 0.15 mm² area target, and the
   target is not reachable as specified** (§5, §6) — 0.2186 mm² summed,
