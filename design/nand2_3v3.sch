...
S {}
E {}
T {gf180-pll :: nand2_3v3 -- 2-input static CMOS NAND, 3.3 V thick-oxide devices
NMOS stack widened 2x so the series pull-down matches a 1x inverter.} -500 -400 0 0 0.4 0.4 {}
C {ipin.sym} -500 -100 0 0 {name=p1 lab=A}
C {ipin.sym} -500 300 0 0 {name=p2 lab=B}
C {opin.sym} 600 0 0 0 {name=p3 lab=Y}
C {iopin.sym} -500 -250 0 0 {name=p4 lab=VDD}
C {iopin.sym} -500 450 0 0 {name=p5 lab=VSS}
...
C {nfet_03v3.sym} 0 100 0 0 {name=MNA model=nfet_03v3 W=2u L=0.28u nf=1 m=1}
C {lab_pin.sym} -20 100 0 0 {name=lc1 lab=A}
C {lab_pin.sym} 20 70 0 0 {name=lc2 lab=Y}
C {lab_pin.sym} 20 130 0 0 {name=lc3 lab=NMID}
C {lab_pin.sym} 20 100 0 0 {name=lc4 lab=VSS}
C {nfet_03v3.sym} 0 300 0 0 {name=MNB model=nfet_03v3 W=2u L=0.28u nf=1 m=1}
C {lab_pin.sym} -20 300 0 0 {name=ld1 lab=B}
C {lab_pin.sym} 20 270 0 0 {name=ld2 lab=NMID}
C {lab_pin.sym} 20 330 0 0 {name=ld3 lab=VSS}
